...
function isPowerOfTwo(num) {
  let isPower = true;
  for (let i = num; i > 0; i = Math.trunc(i / 2)) {
    if (i === 2) break;
    if (i < 2) isPower = false;
  }
  return isPower;
}
...
function isNumber(/* number */) {
  // let isNumberParam = false;
  // let isNotNumber = false;
  // isNumberParam = typeof number === 'number';
  // if (isNumberParam === true) {
  //   if (Number.isFinite(number)) isNotNumber = true;
  //   if (Number.isNaN(number)) isNotNumber = true;
  // }
  // if (isNotNumber === true) isNumberParam = false;
